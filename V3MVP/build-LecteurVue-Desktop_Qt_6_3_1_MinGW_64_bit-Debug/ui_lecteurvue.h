...
public:
    ...
    void setupUi(QMainWindow *LecteurVue)
    {
        ...
        acEnlever->setObjectName(QString::fromUtf8("acEnlever"));
        ...
        actionPantxica->setObjectName(QString::fromUtf8("actionPantxica"));
        actionPantxica->setCheckable(true);
        actionYann = new QAction(LecteurVue);
        actionYann->setObjectName(QString::fromUtf8("actionYann"));
        actionThierry = new QAction(LecteurVue);
        actionThierry->setObjectName(QString::fromUtf8("actionThierry"));
        actionManu = new QAction(LecteurVue);
        actionManu->setObjectName(QString::fromUtf8("actionManu"));
        ...
        horizontalSpacer_4 = new QSpacerItem(50, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_4);

        labTitre = new QLabel(groupBox_2);
        labTitre->setObjectName(QString::fromUtf8("labTitre"));
        ...
        horizontalSpacer_5 = new QSpacerItem(50, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        horizontalSpacer_6 = new QSpacerItem(50, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);

        horizontalLayout_3->addItem(horizontalSpacer_6);

        labCat = new QLabel(groupBox_2);
        labCat->setObjectName(QString::fromUtf8("labCat"));
        ...
        horizontalSpacer_7 = new QSpacerItem(50, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        verticalSpacer_5 = new QSpacerItem(20, 30, QSizePolicy::Minimum, QSizePolicy::MinimumExpanding);

        verticalLayout->addItem(verticalSpacer_5);

        labDiapo = new QLabel(groupBox_2);
        labDiapo->setObjectName(QString::fromUtf8("labDiapo"));
        ...
        horizontalSpacer_9 = new QSpacerItem(78, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        horizontalSpacer_3 = new QSpacerItem(1, 10, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        horizontalSpacer_2 = new QSpacerItem(81, 10, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
