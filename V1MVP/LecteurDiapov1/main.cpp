...
int main()
{
    ...
    while (true)
    {
        ...
        unsigned int position = diaporamas[diaporamaCourant]._localisationImages[imageCourante].getPos();
        lecteur.afficherImageCouranteDansDiaporamaCourant (diaporamas[diaporamaCourant], imageCourante, images[position]);
        ...
        system("cls");  // effacer l'écran
        lecteur.declencherAction(choixAction, diaporamas, diaporamaCourant, imageCourante, images);
    }
