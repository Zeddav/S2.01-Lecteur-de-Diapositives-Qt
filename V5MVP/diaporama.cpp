...
void  Diaporama::chargerIm(Images& pImages) {
    ...
    imageACharger->creerImage("objet", "Tapis", ":/diapo/images/Disney_tapis.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage("personnage", "Blanche Neige", ":/diapo/images/Disney_4.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage ("personnage", "Alice", ":/diapo/images/Disney_2.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage("animal", "Mickey", ":/diapo/images/Disney_19.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage ("personnage", "Pinnochio", ":/diapo/images/Disney_29.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage("objet", "chateau", ":/diapo/images/Disney_0.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage("personnage", "Minnie", ":/diapo/images/Disney_14.gif");
    pImages.push_back(imageACharger);
    imageACharger = new Image ();
    imageACharger->creerImage("animal", "Bambi", ":/diapo/images/Disney_3.gif");
    pImages.push_back(imageACharger);
}
